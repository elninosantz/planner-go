...
const criarItemDeAtividade = (atividade) => {
    ...
    return `
            <div class="card-bg">
                ...
                <time class="full">${formatar.dia.semana.longo}, dia ${formatar.dia.numerico} de ${formatar.mes} às ${formatar.hora}</time>
...
const concluirAtividade = (event) => {
    /*
    marcar ou desmarcar uma atividade como concluída, com base na data vinda de um input que o usuário mudou.
    */
